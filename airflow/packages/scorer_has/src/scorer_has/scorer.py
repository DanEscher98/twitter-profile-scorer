...
if TYPE_CHECKING:
    from scorer_db.models import UserStats
...
def _compute_engagement_score(stats: UserStats) -> Decimal:
    ...
    if ratio > 10:
        ...
        score += Decimal("0.05")
    # else: very low ratio, likely bot or new account
...
def _compute_account_age_score(stats: UserStats) -> Decimal:
    ...
    # Use listed count as proxy for account age/reputation
